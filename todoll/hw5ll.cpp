...
template <class T>
int LinkedList<T>::numberOfNodes() const
{
	int count = 0;
	ListNode * temp = head;
	while(temp != NULL)
...
int main()
{
   ...
   LinkedList<double> listObject;

   // Build the list with some values.
   listObject.appendNode(2.5);
   listObject.appendNode(7.9);
   listObject.appendNode(12.6);

   listObject.deleteHead();

   cout << "itemcount: " << listObject.numberOfNodes() << endl;
   // Display the list.
   cout << "Here are the initial values:\n";
   listObject.displayList(cout);
   cout << endl;
   cout << "value: ";
   cout << listObject[3] << endl;
